...
Android 版と同じキーボード操作（パン・ズーム・目的地設定・音声入力・駐車場検索）に対応した iPad 向けアプリです。地図は MapKit、ルート・駐車場は Google Routes / Places API を使います。

セットアップ・ビルド手順は [`ios/README.md`](ios/README.md) を参照してください。
